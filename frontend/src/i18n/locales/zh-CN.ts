...
export default {
  ...
  common: {
    ...
    feedback: {
      ...
      error_003: '产品不存在或已下架',
      info_004: '产品数据未加载',
      info_005: '仅管理员可访问用户管理页',
      warn_006: '再次输入新密码',
      info_007: '即将触发 ${form.entity
      warn_001: '再次输入新密码',
      info_002: '即将触发 ${form.entity} ETL (${form.mode}${form.dryRun ? ',
      ...
      info_009: '输入产品 ID 加入',
    } ETL (${form.mode}${form.dryRun ? ", 试运行" : ""}), 是否继续?',
      error_008: '复制失败',
      error_009: '复制失败, 请手动选择',
      success_010: '密码修改成功',
      success_011: '已加入: ${data.items[0].oemNoDisplay}',
      success_012: '已加载离线 openapi.json, 后端 Swagger 不可用',
      info_013: '已发送暂停信号, checkpoint_id=${r.checkpointId ?? "?"}, 当前批次跑完后退出',
      success_014: '已复制到剪贴板',
      success_015: '已清空',
      success_016: '已清空搜索条件',
      info_017: '已移除',
      error_018: '已触发测试错误, 请查看下方列表',
      success_019: '已退出登录',
      info_020: '搜索 message / type / tags…',
      info_021: '搜索路径 / 方法 / 摘要…',
      error_022: '无法加载 API 文档',
      error_023: '无法加载 API 文档 (Swagger + 离线备份均失败)',
      info_024: '替代 OEM 表格未就绪',
      warn_025: '最多 500 个 OEM, 当前 ${oems.length}',
      warn_026: '最多对比 ${MAX_COMPARE} 个产品',
      error_027: '服务器繁忙,请稍后重试 (错误码:${status})',
      warn_028: '清空确认',
      error_029: '用户名或密码错误',
      info_030: '登录已过期, 请重新登录',
      warn_031: '确定停售产品 ',
      warn_032: '确定删除 ',
      warn_033: '确定删除品牌 ',
      warn_034: '确定删除用户 ',
      warn_035: '确认',
      info_036: '粘贴 OEM 编号, 每行一个 (支持 tab/换行/逗号/分号分隔)&#10;例如:&#10;OEN-123&#10;AB/CD/456&#10;滤清器 1142',
      info_037: '网络异常: ${err.message || "请稍后重试"}',
      error_038: '网络连接失败,请检查网络',
      warn_039: '至少 8 个字符',
      warn_040: '至少需要输入 1 个搜索字段',
      info_041: '该产品已在对比列表中',
      info_042: '请先登录',
      info_043: '请求超时,请检查网络后重试',
      info_044: '请求频率超限, 请 ${retryAfter || 60}s 后重试',
      error_045: '请粘贴至少一个 OEM 编号',
      error_046: '请输入密码',
      error_047: '请输入当前密码',
      error_048: '请输入有效的产品 ID',
      error_049: '请输入用户名',
      info_050: '输入 045090 试试',
      info_051: '输入产品 ID 加入',
    },
