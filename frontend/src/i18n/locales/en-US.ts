...
export default {
  ...
  common: {
    ...
    feedback: {
      info_001: 'OEM Inquiry',
      success_002: 'cURL copied',
      error_003: 'Product does not exist or has been discontinued',
      info_004: 'Product data not loaded',
      info_005: 'Only administrators can access the user management page',
      warn_006: 'Retype Your New Password',
      info_007: 'About to trigger ${form.entity
      warn_001: 'Re-enter the new password',
      info_002: 'Soon to trigger ETL (${form.dryRun?${form.entity}${form.mode}',
      ...
      warn_009: 'Confirm',
      info_006: 'Network error: ${err.message ||',
    ...
    } ETL (${form.mode}${form.dryRun ? ", dry run" : ""}), continue?',
      error_008: 'Copy failed',
      error_009: 'Copy failed, please select manually',
      success_010: 'Password changed successfully',
      success_011: 'Joined: ${data.items[0].oemNoDisplay}',
      success_012: 'Offline openapi.json loaded, backend Swagger unavailable',
      info_013: 'Pause signal sent, checkpoint_id=${r.checkpointId ?? "?"}, will exit after current batch finishes',
      success_014: 'Copied to clipboard',
      success_015: 'Cleared',
      success_016: 'Search criteria cleared',
      info_017: 'Removed',
      error_018: 'Test error triggered, see list below',
      success_019: 'Logged out',
      info_020: 'Search message/type/tags…',
      info_021: 'Search path / method / summary…',
      error_022: 'Unable to load API documentation',
      error_023: 'Unable to load API documentation (both Swagger + offline backups failed)',
      info_024: 'Alternative OEM form not ready',
      warn_025: 'Up to 500 OEMs, current ${oems.length}',
      warn_026: 'Compare up to ${MAX_COMPARE} products',
      error_027: 'Server is busy, please try again later (Error code: ${status})',
      warn_028: 'Clear confirmation',
      error_029: 'Invalid username or password',
      info_030: 'Session expired, please log in again',
      warn_031: 'Confirm discontinue product ',
      warn_032: 'Confirm delete ',
      warn_033: 'Confirm delete brand ',
      warn_034: 'Confirm delete user ',
      warn_035: 'Confirm',
      info_036: 'Paste OEM numbers, one per line (tab/line break/comma/semicolon delimited)&#10;Example:&#10;OEN-123&#10;AB/CD/456&#10;Filter 1142',
      info_037: 'Network exception: ${err.message || "please try again later"}',
      error_038: 'Network connection failed, please check the network',
      warn_039: '8 characters or more',
      warn_040: 'At least 1 search field is required',
      info_041: 'This product is already in the comparison list',
      info_042: 'Please log in first',
      info_043: 'Request timed out, please check your network and try again',
      info_044: 'Request rate limit exceeded, please try again in ${retryAfter || 60}s',
      error_045: 'Please paste at least one OEM number',
      error_046: 'Please enter password',
      error_047: 'Please enter your current password',
      error_048: 'Please enter a valid Product ID',
      error_049: 'Please enter username',
      info_050: 'Try entering 045090',
      info_051: 'Enter product ID to join',
    },
    ...
    action: {
      ...
      no_data_click_top_right: '> No data, click on the top right',
      created: 'Add',
  ...
  search: {
    ...
    placeholder: 'Search OEM / Name / Vehicle Model...',
    ...
    toleranceDesc: 'Switching tolerance will significantly affect the search speed (10mm is 5-10 times slower than 1mm), by default ± 5mm is the balance point of most scenarios',
