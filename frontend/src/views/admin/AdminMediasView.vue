...
<style scoped>
.dict-head, .dict-row { display: grid; grid-template-columns: 32px 60px 1.4fr 1fr 80px 100px 140px 80px 200px; align-items: center; font-size: 12px; border-bottom: 1px solid #e5e7eb; }
