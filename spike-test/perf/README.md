...
| 指标 | 目标 | 实测 (单用户) | 实测 (50 VU) | 状态 |
|------|------|---------------|---------------|------|
| 公开搜索 P95 | < 200ms | 978ms | 9240ms | ❌ 见优化建议 |
| 公开产品详情 P95 | < 300ms | 2.2ms | 232ms | ✅ 达标 |
| 公开对比 P95 (3个) | < 500ms | 3.5ms | 266ms | ✅ 达标 |
| 整体错误率 | < 0.1% | 0% | 33% (高并发) | ⚠️ 高并发需优化 |

详细报告见 [results/perf-report-20260705.md](results/perf-report-20260705.md)。
